  ...
  return (
    <main className="min-h-screen bg-[#eef2f6] px-6 py-16 text-slate-900 md:px-12 lg:px-20">
      <div className="mx-auto max-w-4xl">
        <h1 className="text-5xl font-semibold tracking-tight">Impressum</h1>
        ...
        <div className="mt-10 space-y-8 rounded-[2rem] bg-white/60 p-8 shadow-[8px_8px_24px_#cfd6df,-8px_-8px_24px_#ffffff]">
          ...
          <section>
            ...
            <p className="mt-4 leading-7 text-slate-600">
              DigiEmu is a deterministic knowledge infrastructure and verification concept
              for reproducible, verifiable and auditable AI-assisted decision states.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 leading-7 text-slate-600">
              ...
              No guarantee is given for completeness, accuracy or current validity.
            </p>
          </section>
        </div>
      </div>
